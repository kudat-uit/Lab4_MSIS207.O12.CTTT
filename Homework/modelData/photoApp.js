...
/* jshint node: true */
/*
 * Model data for UIT Project #5 - the photo sharing site.
 * This module returns an object called UITModels with the following functions:
 *
 * UITModels.userListModel - A function that returns the list of users on the system. The
 ...
 *
 * UITModels.userModel - A function that returns the info of the specified user. Called
 ...
 *   occupation (string) - The occupation of the user.
 *
 * UITModels.photoOfUserModel - A function that returns the photos belong to
 ...
 *
 * UITModels.schemaModel - A function that returns the test info from the fake schema.
...
(function() {
   ...
   var im = {_id: "57231f1a30e4351f4e9f4bd7", first_name: "Thieu Huy", last_name: "Hoang", 
             location: "Austin, TX", description: "Should've stayed in the car.", occupation: "20521350"};
   var er = {_id: "57231f1a30e4351f4e9f4bd8", first_name: "Nguyen Nhat", last_name: "Thuong", 
             location: "Nostromo", description: "Lvl 6 rating. Pilot.", occupation: "20522000"};
   ...
   var jo = {_id: "57231f1a30e4351f4e9f4bdc", first_name: "John", last_name: "Ousterhout",
             location: "Stanford, CA", description: "<i>UIT!</i>", occupation: "Professor"};
